...
fn bench_patterns<T: Ord + std::fmt::Debug>(
    ...
    for (pattern_name, pattern_provider) in pattern_providers.iter() {
        ...
        bench_impl(
            ...
            pattern_name,
            pattern_provider,
            unstable::rust_v2ips4o_rs::SortImpl,
        );
        #[cfg(feature = "rust_ips4o_rs")]
        bench_impl(
            c,
            ...
            pattern_name,
            pattern_provider,
            unstable::rust_v3ips4o_rs::SortImpl,
        );
        #[cfg(feature = "rust_ips4o_rs")]
        bench_impl(
            c,
            ...
            pattern_name,
            pattern_provider,
            unstable::rust_ips4o_par::SortImpl,
        );
        #[cfg(feature = "rust_ips4o_rs")]
        bench_impl(
            c,
            ...
            pattern_name,
            pattern_provider,
            unstable::rust_v3ips4o_par::SortImpl,
        );
...
fn criterion_benchmark(c: &mut Criterion) {
    ...
    // ];
    let test_sizes = [
        8, 10, 12, 17, 24, 35, 49, 70, 100, 200, 400, 900, 2_048, 4_833, 10_000,
        22_367, 50_000, 100_000, 183_845, 400_000, 1_000_000, 2_000_000, 4_281_332, 10_000_000,
        33_333_333, 66_666_666, 100_000_000, 223_478_950, 458_479_203, 1_000_000_000
    ];
